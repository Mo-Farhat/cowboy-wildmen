    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (error instanceof Error) {
                toast.error(error.message || "Failed to establish identity.");
            } else {
                ...
                <div className="w-full max-w-md bg-brandCharcoal p-12 md:p-16 border border-white/5">
                    <div className="text-center mb-10">
                        ...
                        <p className="text-zinc-500 text-[10px] font-black uppercase tracking-widest leading-relaxed">
                            Join the Wildmen for early drops and priority access to rare restocks.
                        </p>
                    </div>
                    ...
                    <div className="mt-10">
                        <div className="relative">
                            ...
                            <div className="relative flex justify-center text-[10px] font-black uppercase tracking-widest text-zinc-600">
                                <span className="px-4 bg-brandCharcoal">
                                    Quick Identity
                                </span>
                            </div>
                        </div>
