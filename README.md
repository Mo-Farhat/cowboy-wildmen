# Cowboy Wildmen Ecommerce Application
...
To set up the Cowboy Wildmen Ecommerce Application, follow these steps carefully:
...
```bash
npm create sanity@latest -- --env=.env.local --create-project "Cowboy Wildmen ecommerce" --dataset production
```
...
- Note: You can verify your NEXT_PUBLIC_SANITY_PROJECT_ID later by logging into https://www.sanity.io/manage, selecting the "Cowboy Wildmen ecommerce" project, and checking the project details.
...
Select your "Cowboy Wildmen ecommerce" project.
...
NEXT_PUBLIC_BASE_URL: Set to http://localhost:3000 for local development. Update to your live domain (e.g., https://Cowboy Wildmen.reactbd.com/) when deploying.
